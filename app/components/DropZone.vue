    ...
    <div class="flex flex-col items-center justify-center gap-4">
      ...
      <div class="mt-4 flex flex-wrap justify-center gap-2 max-w-xl">
        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-medium bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300">
          <UIcon name="i-lucide-file-text" class="w-3.5 h-3.5 text-blue-500" /> PDF
        </span>
        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-medium bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300">
          <UIcon name="i-lucide-file-text" class="w-3.5 h-3.5 text-sky-500" /> Word
        </span>
        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-medium bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300">
          <UIcon name="i-lucide-table-2" class="w-3.5 h-3.5 text-green-500" /> Excel / CSV
        </span>
        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-medium bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300">
          <UIcon name="i-lucide-presentation" class="w-3.5 h-3.5 text-orange-500" /> PPTX
        </span>
        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-medium bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300">
          <UIcon name="i-lucide-code" class="w-3.5 h-3.5 text-purple-500" /> HTML / JSON
        </span>
        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-medium bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300">
          <UIcon name="i-lucide-image" class="w-3.5 h-3.5 text-pink-500" /> Images (OCR)
        </span>
        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-medium bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300">
          <UIcon name="i-lucide-headphones" class="w-3.5 h-3.5 text-yellow-500" /> Audio / Video
        </span>
      </div>
    </div>
  </div>
