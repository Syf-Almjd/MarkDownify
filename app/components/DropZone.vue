...
<template>
  <div
    class="relative border-2 border-dashed rounded-2xl p-8 md:p-12 text-center cursor-pointer transition-all duration-300 select-none group focus:outline-none focus:ring-2 focus:ring-primary-500/50 shadow-sm hover:shadow-lg"
    :class="[
      isDragging
  ...
  >
    ...
    <div class="flex flex-col items-center justify-center gap-4">
      ...
      <div
        class="w-16 h-16 rounded-2xl flex items-center justify-center border border-neutral-200/80 dark:border-neutral-800/80 bg-neutral-50 dark:bg-neutral-900 group-hover:scale-105 group-hover:border-primary-400 group-hover:shadow-md transition-all duration-300"
        :class="[isDragging ? 'border-primary-500 text-primary-500 scale-105 shadow-md' : 'text-neutral-500']"
      >
        <UIcon
