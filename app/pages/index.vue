...
const removeFile = (id: string) => {
  ...
  if (index !== -1) {
    const fileItem = filesQueue.value[index]
    if (fileItem) {
  ...
  <div class="max-w-7xl mx-auto space-y-8 font-sans">
    ...
    <div class="text-center md:text-left space-y-2.5">
      ...
      <p class="text-base text-neutral-500 dark:text-neutral-400 max-w-2xl leading-relaxed">
        Upload PDFs, Word, Excel, PPTX, HTML, or Images. Convert them into clean, structured Markdown natively in your browser. **Save up to 70% of LLM tokens** while retaining pristine layout formatting for prompts.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div class="space-y-2 max-h-[300px] overflow-y-auto pr-1">
            <TransitionGroup name="list">
              <div
                ...
                :key="item.id"
                class="flex items-center gap-3 p-3 rounded-lg border text-left transition-all select-none cursor-pointer"
                :class="[
      ...
      <div class="lg:col-span-8 h-full">
        ...
        >
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full max-w-3xl text-left">
            <div class="p-4 rounded-lg bg-neutral-50/50 dark:bg-neutral-950/50 border border-neutral-200/50 dark:border-neutral-800/80 hover:border-emerald-500/30 transition-all duration-300">
              <UIcon
                name="i-lucide-shield-check"
                class="w-5 h-5 text-emerald-500 mb-2"
              />
            ...
            <div class="p-4 rounded-lg bg-neutral-50/50 dark:bg-neutral-950/50 border border-neutral-200/50 dark:border-neutral-800/80 hover:border-yellow-500/30 transition-all duration-300">
              <UIcon
                name="i-lucide-zap"
                class="w-5 h-5 text-yellow-500 mb-2"
              />
              <h4 class="text-xs font-bold text-neutral-900 dark:text-white uppercase tracking-wider mb-1">
                Instant Parsers
              </h4>
            ...
            <div class="p-4 rounded-lg bg-neutral-50/50 dark:bg-neutral-950/50 border border-neutral-200/50 dark:border-neutral-800/80 hover:border-indigo-500/30 transition-all duration-300">
              <UIcon
                name="i-lucide-brain"
                class="w-5 h-5 text-indigo-500 mb-2"
              />
              <h4 class="text-xs font-bold text-neutral-900 dark:text-white uppercase tracking-wider mb-1">
                Save 70% Tokens
              </h4>
              <p class="text-xs text-neutral-500 leading-relaxed">
                Strips out heavy tags and boilerplate, shrinking context size by ~70% to cut LLM prompt costs.
              </p>
            </div>

            <div class="p-4 rounded-lg bg-neutral-50/50 dark:bg-neutral-950/50 border border-neutral-200/50 dark:border-neutral-800/80 hover:border-blue-500/30 transition-all duration-300">
              <UIcon
                name="i-lucide-eye"
                class="w-5 h-5 text-blue-500 mb-2"
              />
              <h4 class="text-xs font-bold text-neutral-900 dark:text-white uppercase tracking-wider mb-1">
                Split Preview
              </h4>
